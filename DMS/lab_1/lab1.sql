...
--Файл отчёта именуется фамилией студента  в английской транскрипции, с расширением .txt и сохраняется в каталог fpmi-serv604\common-stud\Исаченко\Лаб1\гр_3\Anishchanka.txt.
--Тексты заданий:
