...
--Файл отчёта именуется фамилией студента  в английской транскрипции, с расширением .txt и сохраняется в каталог FPMI-serv604\Common-stud\Исаченко\Лаб\Гр_3\Anishchanka.txt.
--Тексты заданий:
